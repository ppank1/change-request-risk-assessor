module "network" {
  ...
  flow_log_name = "crra-staging-vpc-flow-logs"
...
module "security" {
  ...
  # IAM names are account-global; keep staging distinct from dev.
  name_prefix     = "crra-staging"
  jenkins_sg_name = "crra-staging-jenkins-sg"
  k3s_sg_name     = "crra-staging-k3s-sg"
